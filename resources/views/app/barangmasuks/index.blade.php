            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.barang_masuk.inputs.produk_id')
                            </th>
                            <th class="text-left">
                                @lang('crud.barang_masuk.inputs.supplier_id')
                            </th>
                            <th class="text-right">
                                @lang('crud.barang_masuk.inputs.jumlah')
                            </th>
                            <th class="text-right">
                                @lang('crud.barang_masuk.inputs.harga_beli')
                            </th>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    <a
                                        href="{{ route('barangmasuks.edit', $barangmasuk) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    <a
                                        href="{{ route('barangmasuks.show', $barangmasuk) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    <form
                                        action="{{ route('barangmasuks.destroy', $barangmasuk) }}"
                                        method="POST"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5">{!! $barangmasuks->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
